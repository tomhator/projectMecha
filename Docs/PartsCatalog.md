...
| 파일명 | 이름 | 스킬 | 유형 | base 수치 | base weight | 드롭 가중치 |
|--------|------|------|------|----------|------------|-----------|
| `leg_ha8` | HA-8 중장갑 다리 | 중장갑 전개 | 패시브 | defense +20 | 28 | 13 |
| `leg_ls4` | LS-4 하중 지지 다리 | 하중 분산 | 패시브 | 하중 제한 +25 | 18 | 11 |
| `leg_sz1` | SZ-1 시즈 다리 | 시즈모드 돌입 | 액티브 | 공격력 +35%, AP -1/턴 | 22 | 7 |
| `leg_rc6` | RC-6 반동 다리 | 반동 반격 | 패시브 | 반격 피해 30%, 발동률 40% | 20 | 9 |
| `leg_pr2` | PR-2 선제 도약 다리 | 선제 도약 | 패시브 | 전투 시작 선제 공격 1회 | 16 | 6 |
| `leg_da5` | DA-5 완충 다리 | 충격 완충 | 패시브 | 피해 감소 18% | 24 | 12 |
| `leg_ev7` | EV-7 경량 기동 다리 | 경량 기동 | 패시브 | 회피율 +15%, 하중 제한 +5 | 14 | 10 |
| `leg_jk3` | JK-3 반응 회피 다리 | 반응 회피 | 액티브 | 다음 적 공격 1회 완전 회피 | 15 | 8 |
...
> [!note] 시즈모드 전략
> 시즈모드 ON 상태에서 매 턴 행동력 -1이 누적되므로 장기전보다 단기 화력 집중에 적합.  
> 행동력이 0이 되면 스킬 사용 불가 — 켜는 타이밍과 끄는 타이밍이 핵심 판단.
>
> **EV-7 vs JK-3**: 경량 기동(패시브 확률 회피)은 항상 작동하지만 불확실. 반응 회피(액티브 완전 회피)는 확실하지만 행동력 소모. 적 예고 공격을 보고 JK-3 사용 여부를 결정.

**affix 후보 (안)**

| 파츠 | 후보 affix |
|------|-----------|
| HA-8 중장갑 다리 | 중장갑화, 치명내성, 견고, 코어방어+ |
| LS-4 하중 지지 다리 | 중장갑화, 견고, 패시브쉴드, 코어방어+ |
| SZ-1 시즈 다리 | 코어공격+, 조건저HP, 연계발화, AP환급 |
| RC-6 반동 다리 | 조건피해후, 코어방어+, 연계발화, 강화부가 |
| PR-2 선제 도약 다리 | 코어공격+, AP환급, 연계발화, 경량화 |
| DA-5 완충 다리 | 치명내성, 견고, 중장갑화, 패시브쉴드 |
| EV-7 경량 기동 다리 | 경량화, AP환급, 조건피해후, 코어공격+ |
| JK-3 반응 회피 다리 | 조건피해후, AP환급, 경량화, 코어방어+ |
