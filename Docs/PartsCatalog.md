...
|--------|------|------|------------|------------|-----------|
| `arm_l_m88` | 대구경 반자동 캐논 (좌) | 대구경 포격 | 38 | 25 | 15 |
| `arm_l_gr21` | 자동 기관포 (좌) | 기관포 연사 | 9×5 | 18 | 14 |
| `arm_l_lg40` | 레일건 (좌) | 관통 포격 | 42 | 22 | 8 |
| `arm_l_ml7` | 다연장 유도 미사일 시스템 (좌) | 유도 미사일 공격 | 18×3 | 20 | 10 |
...
|--------|------|------|------|----------|------------|-----------|
| `back_sd7` | 방어막 발생기 | 방어막 전개 | 액티브 | 쉴드 버프 3턴 (+12/턴) | 14 | 13 |
| `back_ex9` | 강화 외골격 팩 | 외골격 강화 | 액티브 | max HP +35·즉시 HP +35 | 20 | 12 |
| `back_tb3` | 전술 부스터 팩 | 부스터 점화 | 액티브 | AP +1 (1턴) | 12 | 10 |
| `back_nr5` | 나노 수복기 | 나노 수복 | 액티브 | HP 회복 버프 3턴 (+10/턴) | 10 | 13 |
| `back_pa6` | 출력 증폭기 | 출력 증폭 | 액티브 | 스킬 수치 버프 3턴 (+15%) | 16 | 8 |
| `back_md2` | 정비 드론 팩 | 드론 정비 | 액티브 | 전 파츠 손상도 +2 즉시 | 11 | 9 |
| `back_tr4` | 전술 중계기 | 중계 강화 | 액티브 | 버프 지속 +2턴 | 13 | 7 |
| `back_fr1` | 현장 수리 키트 | 현장 수리 | 액티브 | 손상도 max 복구 | 9 | 8 |
